...
df = pd.read_csv('AMJLAND.csv',header=[0])            """
...
df.to_csv (r'D:\000Finance\FOFA ASSIGNMENT 2\85_Shubh_2018A2PS0832H_DELTACORP\2 daily Returns (risk unadjusted) AMJLAND.csv', header=True)
